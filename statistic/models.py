...
class Activedevicelog(models.Model):
    ...
    umengdeviceinfo = models.CharField(db_column='UmengDeviceInfo', max_length=120, blank=True, null=True)  # Field name made lowercase.
    umengchannel = models.CharField(db_column='UmengChannel', max_length=20, blank=True, null=True)  # Field name made lowercase.
...
class Autodomainconfig(models.Model):
    id = models.AutoField(db_column='Id', primary_key=True)  # Field name made lowercase.
    domainconfigidx = models.ForeignKey('Domainconfig', models.DO_NOTHING, db_column='DomainConfigIdx')  # Field name made lowercase.
    time = models.DateTimeField(db_column='Time', blank=True, null=True)  # Field name made lowercase.
...
class Configinfo(models.Model):
    ...
    enablemesg = models.TextField(db_column='EnableMesg', blank=True, null=True)  # Field name made lowercase. This field type is a guess.
    enableurl = models.TextField(db_column='EnableUrl', blank=True, null=True)  # Field name made lowercase. This field type is a guess.
    certid = models.ForeignKey('Domaincert', models.DO_NOTHING, db_column='CertId', blank=True, null=True)  # Field name made lowercase.
...
class Domaincert(models.Model):
    ...
    cert = models.TextField(db_column='Cert', blank=True, null=True)  # Field name made lowercase. This field type is a guess.
    time = models.DateTimeField(db_column='Time', blank=True, null=True)  # Field name made lowercase.
...
class Domainconfig(models.Model):
    id = models.AutoField(db_column='Id', primary_key=True)  # Field name made lowercase.
    domain = models.CharField(db_column='Domain', max_length=50)  # Field name made lowercase.
    incomingconfig = models.ForeignKey(Configinfo, models.DO_NOTHING, db_column='IncomingConfig', related_name='domain_incoming_config')  # Field name made lowercase.
    outgoingconfig = models.ForeignKey(Configinfo, models.DO_NOTHING, db_column='OutgoingConfig', related_name='domain_outgoing_config')  # Field name made lowercase.
    type = models.IntegerField(db_column='Type')  # Field name made lowercase.
...
class Domainwelcome(models.Model):
    id = models.AutoField(db_column='Id', primary_key=True)  # Field name made lowercase.
    domain = models.CharField(db_column='Domain', max_length=50)  # Field name made lowercase.
    easwelcome = models.CharField(db_column='EASWelcome', max_length=100, blank=True, null=True)  # Field name made lowercase.
    imapwelcome = models.CharField(db_column='IMAPWelcome', max_length=100, blank=True, null=True)  # Field name made lowercase.
    popwelcome = models.CharField(db_column='POPWelcome', max_length=100, blank=True, null=True)  # Field name made lowercase.
...
class Filterconfig(models.Model):
    ...
    jsonguid = models.CharField(db_column='JsonGuid', max_length=100, blank=True, null=True)  # Field name made lowercase.
...
class Latestemailconfig(models.Model):
    ...
    incomingconfig = models.ForeignKey('Userconfiginfo', models.DO_NOTHING, db_column='IncomingConfig', related_name='latest_incoming_config')  # Field name made lowercase.
    outgoingconfig = models.ForeignKey('Userconfiginfo', models.DO_NOTHING, db_column='OutgoingConfig', related_name='latest_outgoing_config')  # Field name made lowercase.
...
class Proxyconfig(models.Model):
    ...
    originaddress = models.CharField(db_column='OriginAddress', max_length=100, blank=True, null=True)  # Field name made lowercase.
    port = models.IntegerField(db_column='Port')  # Field name made lowercase.
...
class Userconfiglog(models.Model):
    ...
    protocol = models.IntegerField(db_column='Protocol')  # Field name made lowercase.
    incomingconfig = models.ForeignKey(Userconfiginfo, models.DO_NOTHING, db_column='IncomingConfig', related_name='log_incoming_config')  # Field name made lowercase.
    outgoingconfig = models.ForeignKey(Userconfiginfo, models.DO_NOTHING, db_column='OutgoingConfig', related_name='log_outgoing_config')  # Field name made lowercase.
    loginname = models.CharField(db_column='LoginName', max_length=100, blank=True, null=True)  # Field name made lowercase.
    reporttime = models.DateTimeField(db_column='ReportTime')  # Field name made lowercase.
    imei = models.CharField(db_column='Imei', max_length=50, blank=True, null=True)  # Field name made lowercase.
    osversion = models.IntegerField(db_column='OsVersion', blank=True, null=True)  # Field name made lowercase.
    firstsuccess = models.IntegerField(db_column='FirstSuccess', blank=True, null=True)  # Field name made lowercase.
    firstappversion = models.CharField(db_column='FirstAppVersion', max_length=50, blank=True, null=True)  # Field name made lowercase.
    firstappchannel = models.CharField(db_column='FirstAppChannel', max_length=50, blank=True, null=True)  # Field name made lowercase.
    appversion = models.CharField(db_column='AppVersion', max_length=50, blank=True, null=True)  # Field name made lowercase.
    model = models.CharField(db_column='Model', max_length=50, blank=True, null=True)  # Field name made lowercase.
...
class Userconfigtask(models.Model):
    ...
    currentconfig = models.TextField(db_column='CurrentConfig', blank=True, null=True)  # Field name made lowercase. This field type is a guess.
    status = models.IntegerField(db_column='Status')  # Field name made lowercase.
...
class Userhelplog(models.Model):
    id = models.AutoField(db_column='Id', primary_key=True)  # Field name made lowercase.
    email = models.CharField(db_column='Email', max_length=50)  # Field name made lowercase.
    otheremail = models.CharField(db_column='OtherEmail', max_length=200, blank=True, null=True)  # Field name made lowercase.
    contactinfo = models.CharField(db_column='ContactInfo', max_length=100, blank=True, null=True)  # Field name made lowercase.
    helpproblem = models.CharField(db_column='HelpProblem', max_length=200, blank=True, null=True)  # Field name made lowercase.
    imei = models.CharField(db_column='Imei', max_length=50, blank=True, null=True)  # Field name made lowercase.
    osversion = models.IntegerField(db_column='OsVersion', blank=True, null=True)  # Field name made lowercase.
    appversion = models.CharField(db_column='AppVersion', max_length=50, blank=True, null=True)  # Field name made lowercase.
    model = models.CharField(db_column='Model', max_length=50, blank=True, null=True)  # Field name made lowercase.
    ...
    problempath = models.TextField(db_column='ProblemPath', blank=True, null=True)  # Field name made lowercase. This field type is a guess.
